(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),exports, require('@angular/common'), require('@angular/core'), require('@angular/platform-server'), require('@ionic/core/hydrate')) :
    typeof define === 'function' && define.amd ? define('@ionic/angular-server', ['@angular/core','exports', '@angular/common', '@angular/core', '@angular/platform-server', '@ionic/core/hydrate'], factory) :
    (global = global || self, factory(global.ng.core,(global.ionic = global.ionic || {}, global.ionic['angular-server'] = {}), global.ng.common, global.ng.core, global.ng['platform-server'], global.hydrate));
}(this, (function (ɵngcc0,exports, common, core, platformServer, hydrate) { 'use strict';
